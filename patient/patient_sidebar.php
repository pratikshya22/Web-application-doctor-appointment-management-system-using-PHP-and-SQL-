...
<div id="sidebar" class="sidebar">
    <div class="p-4">
        <button class="btn btn-primary btn-block mb-4" style="background-color: white; color: black;">Patient Dashboard</button>
        <ul class="list-unstyled">
            ...
            <li class="mb-2"><a href="../appointment/appoint.php" class="text-decoration-none d-block py-2 px-4 rounded hover-bg-light">Book Appointment</a></li>

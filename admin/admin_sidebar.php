...
<div id="sidebar" class="sidebar">
    <div class="p-4">
        <button class="btn btn-primary btn-block mb-4"> 
            <a href="dashboard.php" style="color: black;">Admin Dashboard</a>
        </button>
        <ul class="list-unstyled">
            <li class="mb-2"><a href="../index.php" class="text-decoration-none d-block py-2 px-4 rounded">Home</a></li>
            <li class="mb-2"><a href="../specialization/read.php" class="text-decoration-none d-block py-2 px-4 rounded">View Specialization</a></li>
            <li class="mb-2"><a href="edit_profile.php" class="text-decoration-none d-block py-2 px-4 rounded">Edit Profile</a></li>

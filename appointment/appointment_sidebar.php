...
<div id="sidebar" class="sidebar">
    <div class="p-4">
        <button class="btn btn-primary btn-block mb-4" style="background-color: white;">
        ...
        <ul class="list-unstyled">
            ...
            <li class="mb-2"><a href="../admin/edit_profile.php" class="text-decoration-none d-block py-2 px-4 rounded hover-bg-light">Edit Profile</a></li>
